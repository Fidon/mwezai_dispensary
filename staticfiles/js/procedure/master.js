...
// count patients waiting for ultrasound services
var formData = new FormData();
formData.append("depart_id", 6);
$.ajax({
    type: 'POST',
    url: "/procedure/countpatients/",
    data: formData,
    dataType: 'json',
    contentType: false,
    processData: false,
    ...
    success: function(response) {
        if(response.success) {
            ...
            $("#patient_count").html("<i class='fas fa-hospital-user'></i> &nbsp; Patients ("+count+")");
        }
    },
