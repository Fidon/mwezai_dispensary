...
$(function () {
    ...
    $("#lab_tests_table thead tr").clone(true).attr('class','filters').appendTo('#lab_tests_table thead');
    var table = $("#lab_tests_table").DataTable({
        fixedHeader: true,
        processing: true,
        serverSide: true,
        ajax: {
            url: "/manage/retrieve_data/param/labtests_3/",
            type: "POST",
            data: function (d) {
        ...
        },
        {
            targets: 5,
            createdCell: function (cell, cellData, rowData, rowIndex, colIndex) {
                var cell_content =`<a href="/manage/services/i/${rowData.id}/d/3/" class="btn btn-bblue text-white">view</a>`;
        ...
        buttons: [
            { // Copy button
                ...
                titleAttr: "Copy",
                title: "Lab tests - Mwezai dispensary",
                exportOptions: {
                    columns: [0, 1, 2, 3]
                }
            },
    ...
    $("#search_lab_inpt").keyup(function() {
