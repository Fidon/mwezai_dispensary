$(function () {
    ...
    $("#lab_report_table thead tr").clone(true).attr('class','filters').appendTo('#lab_report_table thead');
    var table = $("#lab_report_table").DataTable({
        fixedHeader: true,
        processing: true,
        serverSide: true,
        ajax: {
            url: "/manage/reports/labolatory/",
            type: "POST",
            data: function (d) {
        ...
        buttons: [
            { // Copy button
                ...
                titleAttr: "Copy",
                title: "Labolatory report - Mwezai dispensary",
                exportOptions: {
                    columns: [0, 1, 2, 3, 4, 5]
                }
            },
            { // PDF button
                ...
                customize: function(doc) {
                    ...
                    doc['footer'] = (function(page, pages) {
                        var tfoot = $("#lab_report_table tfoot tr:eq(1)");
                        return {
                            columns: [{
                                alignment: 'center',
