$(function () {
    ...
    $("#usound_report_table thead tr").clone(true).attr('class','filters').appendTo('#usound_report_table thead');
    var table = $("#usound_report_table").DataTable({
        fixedHeader: true,
        processing: true,
        serverSide: true,
        ajax: {
            url: "/manage/reports/ultrasound/",
            type: "POST",
            data: function (d) {
            ...
            { // PDF button
                ...
                customize: function(doc) {
                    ...
                    doc['footer'] = (function(page, pages) {
                        var tfoot = $("#usound_report_table tfoot tr:eq(1)");
                        return {
                            columns: [{
                                alignment: 'center',
